...
import { _ as _export_sfc, $ as $$BaseLayout } from "./BaseLayout.CpC1g6Ns.js";
...
import { c as cn, b as buttonVariants, B as Button } from "./index.CZvBHhPq.js";
import { u as unwrapList, d as mapPcRecord, I as Input, e as buildPcTargetUrl } from "./Input.T7es7t3R.js";
...
import { d as authStore, p as pcApi, f as DialogDescription, D as DialogTitle, a as DialogHeader, h as DialogScrollContent, c as Dialog } from "./DialogTrigger.2nV2h0RV.js";
import { reactiveOmit } from "@vueuse/core";
import { Check, Circle, ChevronRight } from "lucide-vue-next";
import { S as SafeIcon } from "./SafeIcon.Qdz7K7DD.js";
import { L as LoginDialog } from "./LoginDialog.DIq0Nv_I.js";
/* empty css                                   */
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: $setup.props.embedded ? "space-y-4" : "page-body space-y-6" }, _attrs))} data-v-50f9c0b1>`), $setup.props.embedded ? _push("<!---->") : _push('<div class="flex flex-col gap-2" data-v-50f9c0b1><h1 class="text-page-title" data-v-50f9c0b1>浏览足迹</h1><p class="text-caption" data-v-50f9c0b1>你浏览过的主页、分类和产品会展示在这里</p></div>'), _push(`<div class="${ssrRenderClass($setup.props.embedded ? "" : "surface-base card-padding")}" data-v-50f9c0b1><div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between" data-v-50f9c0b1>`), _push(ssrRenderComponent($setup.Tabs, { value: $setup.activeTab, "onUpdate:modelValue": $setup.handleTabChange, class: "lg:w-auto" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
  ...
  }), _: 1 }, _parent)), _push('<div class="relative min-w-0 flex-1 lg:max-w-md" data-v-50f9c0b1>'), _push(ssrRenderComponent($setup.SafeIcon, { name: "Search", size: 18, class: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" }, null, _parent)), _push(ssrRenderComponent($setup.Input, { type: "text", placeholder: "搜索浏览记录...", value: $setup.keyword, class: "pl-10 h-10 bg-muted/50 border-none focus-visible:ring-1 focus-visible:ring-primary", onInput: $setup.handleKeywordInput, onKeyup: $setup.handleSearch }, null, _parent)), _push("</div></div></div>"), $setup.isLoading ? (_push('<div class="py-12 text-center text-muted-foreground" data-v-50f9c0b1>'), _push(ssrRenderComponent($setup.SafeIcon, { name: "Loader2", size: 24, class: "mx-auto mb-2 animate-spin" }, null, _parent)), _push(" 加载中... </div>")) : $setup.totalItems === 0 ? (_push('<div class="py-12" data-v-50f9c0b1>'), _push(ssrRenderComponent($setup.EmptyState, { icon: "History", title: "暂无足迹", description: "你浏览过的主页、分类和产品会展示在这里" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
  ...
  }), _: 1 }, _parent)), _push("</div>")) : (_push('<div class="surface-base overflow-hidden flex flex-col" data-v-50f9c0b1><div class="overflow-x-auto" data-v-50f9c0b1>'), _push(ssrRenderComponent($setup.Table, { class: "w-full" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      if (_push3) _push3("<!--[-->"), ssrRenderList($setup.paginatedRecords, (record) => {
        _push3(ssrRenderComponent($setup.TableRow, { key: record.id, class: "border-b border-border hover:bg-muted/30 transition-colors" }, { default: withCtx((_3, _push4, _parent4, _scopeId3) => {
          if (_push4) _push4(ssrRenderComponent($setup.TableCell, { class: "px-4 py-3" }, { default: withCtx((_4, _push5, _parent5, _scopeId4) => {
            if (_push5) _push5(`<div class="w-16 h-16 rounded-md overflow-hidden bg-muted flex items-center justify-center shrink-0" data-v-50f9c0b1${_scopeId4}>`), record.coverUrl ? _push5(`<img${ssrRenderAttr("src", record.coverUrl)}${ssrRenderAttr("alt", record.title)} class="w-full h-full object-cover" data-v-50f9c0b1${_scopeId4}>`) : _push5(ssrRenderComponent($setup.SafeIcon, { name: "Image", size: 24, class: "text-muted-foreground" }, null, _parent5, _scopeId4)), _push5("</div>");
            ...
            if (_push5) _push5(`<div class="flex flex-col gap-1" data-v-50f9c0b1${_scopeId4}><p class="text-item-title font-medium truncate" data-v-50f9c0b1${_scopeId4}>${ssrInterpolate(record.title)}</p><p class="text-caption truncate" data-v-50f9c0b1${_scopeId4}>${ssrInterpolate(record.subtitle)}</p></div>`);
            ...
            if (_push5) _push5(`<div class="flex items-center justify-end gap-2" data-v-50f9c0b1${_scopeId4}>`), _push5(ssrRenderComponent($setup.Button, { variant: "ghost", size: "sm", class: "h-8 px-3 text-xs", onClick: ($event) => $setup.handleView(record) }, { default: withCtx((_5, _push6, _parent6, _scopeId5) => {
              if (_push6) _push6(ssrRenderComponent($setup.SafeIcon, { name: "Eye", size: 14, class: "mr-1" }, null, _parent6, _scopeId5)), _push6(" 查看 ");
              else return [createVNode($setup.SafeIcon, { name: "Eye", size: 14, class: "mr-1" }), createTextVNode(" 查看 ")];
...
const BrowsingHistoryContent = _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-50f9c0b1"]]);
