...
import { _ as _export_sfc, $ as $$BaseLayout } from "./BaseLayout.cTiqBCPS.js";
...
import { c as cn, B as Button } from "./index.gwJhr38l.js";
...
import { L as LoginDialog } from "./LoginDialog.zGObGOwz.js";
import { d as authStore, p as pcApi } from "./DialogTrigger.DL_BFsqe.js";
/* empty css                                   */
...
const _sfc_main = defineComponent({ __name: "CommonHeader", props: { isAuthenticated: { type: Boolean, default: false }, userName: { default: "访客用户" }, userAvatar: { default: "" }, currentPath: { default: "./share-home.html" } }, setup(__props, { expose: __expose }) {
  ...
  onMounted(() => {
    authStore.consumeCallbackToken(), userInfo.value = authStore.getUser() || {}, authStore.isLoggedIn() && pcApi.getCurrentUser().then((profile) => {
      userInfo.value = profile || {}, authStore.setUser(profile);
    }).catch(() => {
    });
  });
