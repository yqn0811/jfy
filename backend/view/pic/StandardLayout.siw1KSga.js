...
import { _ as _export_sfc, $ as $$BaseLayout } from "./BaseLayout.BBSmdN3R.js";
import { defineComponent, useSSRContext, mergeProps, withCtx, renderSlot, createVNode, createTextVNode, toDisplayString, unref, computed, ref, onMounted, createBlock, openBlock, Fragment, renderList, createCommentVNode, reactive, watch } from "vue";
import { c as cn, b as buttonVariants, B as Button } from "./index.C1wyLi3K.js";
import { u as unwrapList, d as mapPcRecord, I as Input, e as buildPcTargetUrl } from "./Input._PZLryNp.js";
...
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import { d as authStore, p as pcApi, f as DialogDescription, D as DialogTitle, a as DialogHeader, h as DialogScrollContent, c as Dialog } from "./DialogTrigger.Dl5MdGFX.js";
import { reactiveOmit } from "@vueuse/core";
import { Check, Circle, ChevronRight } from "lucide-vue-next";
import { S as SafeIcon } from "./SafeIcon.C41I4Ca-.js";
import { L as LoginDialog } from "./LoginDialog.D8jZd2Nm.js";
/* empty css                                   */
import { toast } from "vue-sonner";
const _sfc_main$J = defineComponent({ __name: "Avatar", props: { class: {}, size: { default: "sm" }, shape: { default: "circle" } }, setup(__props, { expose: __expose }) {
  __expose();
...
_sfc_main$J.setup = (props, ctx) => {
  ...
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/avatar/Avatar.vue"), _sfc_setup$J ? _sfc_setup$J(props, ctx) : void 0;
};
const Avatar = _export_sfc(_sfc_main$J, [["ssrRender", _sfc_ssrRender$J]]);
const _sfc_main$I = defineComponent({ __name: "AvatarFallback", props: { delayMs: {}, asChild: { type: Boolean }, as: {} }, setup(__props, { expose: __expose }) {
  __expose();
...
_sfc_main$I.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/avatar/AvatarFallback.vue"), _sfc_setup$I ? _sfc_setup$I(props, ctx) : void 0;
};
const AvatarFallback = _export_sfc(_sfc_main$I, [["ssrRender", _sfc_ssrRender$I]]);
const _sfc_main$H = defineComponent({ __name: "AvatarImage", props: { src: {}, referrerPolicy: {}, crossOrigin: {}, asChild: { type: Boolean }, as: {} }, setup(__props, { expose: __expose }) {
  __expose();
...
_sfc_main$H.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/avatar/AvatarImage.vue"), _sfc_setup$H ? _sfc_setup$H(props, ctx) : void 0;
};
const AvatarImage = _export_sfc(_sfc_main$H, [["ssrRender", _sfc_ssrRender$H]]);
...
const _sfc_main$z = defineComponent({ __name: "DropdownMenuRadioItem", props: { value: {}, disabled: { type: Boolean }, textValue: {}, asChild: { type: Boolean }, as: {}, class: {} }, emits: ["select"], setup(__props, { expose: __expose, emit: __emit }) {
  __expose();
...
_sfc_main$z.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/dropdown-menu/DropdownMenuRadioItem.vue"), _sfc_setup$z ? _sfc_setup$z(props, ctx) : void 0;
};
_export_sfc(_sfc_main$z, [["ssrRender", _sfc_ssrRender$z]]);
const _sfc_main$y = defineComponent({ __name: "DropdownMenuSeparator", props: { asChild: { type: Boolean }, as: {}, class: {} }, setup(__props, { expose: __expose }) {
  __expose();
...
_sfc_main$y.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/dropdown-menu/DropdownMenuSeparator.vue"), _sfc_setup$y ? _sfc_setup$y(props, ctx) : void 0;
};
const DropdownMenuSeparator = _export_sfc(_sfc_main$y, [["ssrRender", _sfc_ssrRender$y]]);
const _sfc_main$x = defineComponent({ __name: "DropdownMenuShortcut", props: { class: {} }, setup(__props, { expose: __expose }) {
  __expose();
...
_sfc_main$x.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/dropdown-menu/DropdownMenuShortcut.vue"), _sfc_setup$x ? _sfc_setup$x(props, ctx) : void 0;
};
_export_sfc(_sfc_main$x, [["ssrRender", _sfc_ssrRender$x]]);
const _sfc_main$w = defineComponent({ __name: "DropdownMenuSub", props: { defaultOpen: { type: Boolean }, open: { type: Boolean } }, emits: ["update:open"], setup(__props, { expose: __expose, emit: __emit }) {
  __expose();
...
_sfc_main$w.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/dropdown-menu/DropdownMenuSub.vue"), _sfc_setup$w ? _sfc_setup$w(props, ctx) : void 0;
};
_export_sfc(_sfc_main$w, [["ssrRender", _sfc_ssrRender$w]]);
const _sfc_main$v = defineComponent({ __name: "DropdownMenuSubContent", props: { forceMount: { type: Boolean }, loop: { type: Boolean }, sideOffset: {}, sideFlip: { type: Boolean }, alignOffset: {}, alignFlip: { type: Boolean }, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {}, class: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "entryFocus", "openAutoFocus", "closeAutoFocus"], setup(__props, { expose: __expose, emit: __emit }) {
  __expose();
...
_sfc_main$v.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/dropdown-menu/DropdownMenuSubContent.vue"), _sfc_setup$v ? _sfc_setup$v(props, ctx) : void 0;
};
_export_sfc(_sfc_main$v, [["ssrRender", _sfc_ssrRender$v]]);
const _sfc_main$u = defineComponent({ __name: "DropdownMenuSubTrigger", props: { disabled: { type: Boolean }, textValue: {}, asChild: { type: Boolean }, as: {}, class: {} }, setup(__props, { expose: __expose }) {
  __expose();
...
_sfc_main$u.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/dropdown-menu/DropdownMenuSubTrigger.vue"), _sfc_setup$u ? _sfc_setup$u(props, ctx) : void 0;
};
_export_sfc(_sfc_main$u, [["ssrRender", _sfc_ssrRender$u]]);
const _sfc_main$t = defineComponent({ __name: "DropdownMenuTrigger", props: { disabled: { type: Boolean }, asChild: { type: Boolean }, as: {} }, setup(__props, { expose: __expose }) {
  __expose();
...
_sfc_main$t.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  return (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/ui/dropdown-menu/DropdownMenuTrigger.vue"), _sfc_setup$t ? _sfc_setup$t(props, ctx) : void 0;
};
const DropdownMenuTrigger = _export_sfc(_sfc_main$t, [["ssrRender", _sfc_ssrRender$t]]);
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: $setup.props.embedded ? "flex min-h-0 flex-col" : "page-body flex flex-col min-h-screen" }, _attrs))} data-v-26bd6809>`), $setup.props.embedded ? _push("<!---->") : _push('<div class="mb-6" data-v-26bd6809><h1 class="text-page-title mb-2" data-v-26bd6809>我的收藏</h1><p class="text-caption" data-v-26bd6809>你收藏的主页、分类和产品会展示在这里</p></div>'), _push(`<div class="${ssrRenderClass($setup.props.embedded ? "mb-4" : "surface-base card-padding mb-6")}" data-v-26bd6809><div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between" data-v-26bd6809>`), _push(ssrRenderComponent($setup.Tabs, { "model-value": $setup.activeTab, "onUpdate:modelValue": (value) => $setup.handleTabChange(value), class: "lg:w-auto" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
  ...
  }), _: 1 }, _parent)), _push("</div></div></div>"), $setup.isClient ? _push("<!---->") : _push('<div class="flex-1" data-v-26bd6809></div>'), $setup.isClient ? (_push('<div class="flex-1 flex flex-col min-h-0" data-v-26bd6809>'), $setup.isLoggedIn ? !$setup.isLoading && $setup.totalItems === 0 ? (_push('<div class="flex-1 flex items-center justify-center" data-v-26bd6809>'), _push(ssrRenderComponent($setup.EmptyState, { icon: "Heart", title: "暂无收藏", description: "你收藏的主页、分类和产品会展示在这里" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
  ...
  }), _: 1 }, _parent)), _push("</div>")) : $setup.isLoading ? (_push('<div class="flex-1 flex items-center justify-center text-muted-foreground" data-v-26bd6809>'), _push(ssrRenderComponent($setup.SafeIcon, { name: "Loader2", size: 24, class: "mr-2 animate-spin" }, null, _parent)), _push(" 加载中... </div>")) : (_push('<!--[--><div class="surface-base overflow-hidden flex flex-col flex-1" data-v-26bd6809><div class="overflow-x-auto" data-v-26bd6809>'), _push(ssrRenderComponent($setup.Table, null, { default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      if (_push3) _push3("<!--[-->"), ssrRenderList($setup.paginatedFavorites, (fav) => {
        _push3(ssrRenderComponent($setup.TableRow, { key: fav.id, class: "border-b border-border hover:bg-muted/50 transition-colors" }, { default: withCtx((_3, _push4, _parent4, _scopeId3) => {
          if (_push4) _push4(ssrRenderComponent($setup.TableCell, { class: "w-20 py-3" }, { default: withCtx((_4, _push5, _parent5, _scopeId4) => {
            if (_push5) _push5(`<div class="w-16 h-16 rounded-md overflow-hidden bg-muted/50 flex-shrink-0" data-v-26bd6809${_scopeId4}><img${ssrRenderAttr("src", $setup.getFavoriteCover(fav))}${ssrRenderAttr("alt", $setup.getFavoriteTitle(fav))} class="w-full h-full object-cover" data-v-26bd6809${_scopeId4}></div>`);
            ...
            if (_push5) _push5(`<span class="inline-block px-2 py-1 text-xs font-medium rounded bg-muted text-muted-foreground" data-v-26bd6809${_scopeId4}>${ssrInterpolate(fav.targetType === "home" ? "主页" : fav.targetType === "category" ? "分类" : "产品")}</span>`);
            ...
            if (_push5) _push5(`<div class="flex items-center justify-end gap-2" data-v-26bd6809${_scopeId4}>`), _push5(ssrRenderComponent($setup.Button, { variant: "outline", size: "sm", class: "h-8 px-3 text-xs", onClick: ($event) => $setup.handleView(fav) }, { default: withCtx((_5, _push6, _parent6, _scopeId5) => {
  ...
  }), _: 1 }, _parent)), _push('</div></div><div class="mt-6" data-v-26bd6809>'), _push(ssrRenderComponent($setup.Pagination, { current: $setup.currentPage, total: $setup.totalItems, "page-size": $setup.pageSize, "onUpdate:current": $setup.handlePageChange }, null, _parent)), _push("</div><!--]-->")) : (_push('<div class="flex-1 flex items-center justify-center" data-v-26bd6809>'), _push(ssrRenderComponent($setup.EmptyState, { icon: "ShieldCheck", title: "请先登录", description: "登录后可以查看你在小程序和网页收藏的主页、分类和产品" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
...
const FavoritesList = _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-26bd6809"]]);
...
const pageSize = 20, _sfc_main$1 = defineComponent({ __name: "BrowsingHistoryContent", props: { embedded: { type: Boolean, default: false } }, setup(__props, { expose: __expose }) {
  __expose();
  const props = __props, isClient = ref(true), activeTab = ref("all"), keyword = ref(""), currentPage = ref(1), isLoading = ref(false), serverTotal = ref(0), browsingRecords = ref([]), favorites = ref([]), confirmDialog = reactive({ open: false, recordId: "" }), filteredRecords = computed(() => browsingRecords.value), totalItems = computed(() => serverTotal.value || filteredRecords.value.length), paginatedRecords = computed(() => filteredRecords.value), loadRecords = async () => {
    ...
    activeTab.value = tab, currentPage.value = 1, await loadRecords();
  }, handleSearch = () => {
  ...
  onMounted(async () => {
    ...
    window.scrollTo({ top: 0, behavior: "smooth" }), loadRecords();
  });
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: $setup.props.embedded ? "space-y-4" : "page-body space-y-6" }, _attrs))} data-v-5037d8ef>`), $setup.props.embedded ? _push("<!---->") : _push('<div class="flex flex-col gap-2" data-v-5037d8ef><h1 class="text-page-title" data-v-5037d8ef>浏览足迹</h1><p class="text-caption" data-v-5037d8ef>你浏览过的主页、分类和产品会展示在这里</p></div>'), _push(`<div class="${ssrRenderClass($setup.props.embedded ? "" : "surface-base card-padding")}" data-v-5037d8ef><div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between" data-v-5037d8ef>`), _push(ssrRenderComponent($setup.Tabs, { value: $setup.activeTab, "onUpdate:modelValue": $setup.handleTabChange, class: "lg:w-auto" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
  ...
  }), _: 1 }, _parent)), _push('<div class="relative min-w-0 flex-1 lg:max-w-md" data-v-5037d8ef>'), _push(ssrRenderComponent($setup.SafeIcon, { name: "Search", size: 18, class: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" }, null, _parent)), _push(ssrRenderComponent($setup.Input, { type: "text", placeholder: "搜索浏览记录...", value: $setup.keyword, class: "pl-10 h-10 bg-muted/50 border-none focus-visible:ring-1 focus-visible:ring-primary", onInput: $setup.handleKeywordInput, onKeyup: $setup.handleSearch }, null, _parent)), _push("</div></div></div>"), $setup.isLoading ? (_push('<div class="py-12 text-center text-muted-foreground" data-v-5037d8ef>'), _push(ssrRenderComponent($setup.SafeIcon, { name: "Loader2", size: 24, class: "mx-auto mb-2 animate-spin" }, null, _parent)), _push(" 加载中... </div>")) : $setup.totalItems === 0 ? (_push('<div class="py-12" data-v-5037d8ef>'), _push(ssrRenderComponent($setup.EmptyState, { icon: "History", title: "暂无足迹", description: "你浏览过的主页、分类和产品会展示在这里" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
  ...
  }), _: 1 }, _parent)), _push("</div>")) : (_push('<div class="surface-base overflow-hidden flex flex-col" data-v-5037d8ef><div class="overflow-x-auto" data-v-5037d8ef>'), _push(ssrRenderComponent($setup.Table, { class: "w-full" }, { default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      if (_push3) _push3("<!--[-->"), ssrRenderList($setup.paginatedRecords, (record) => {
        _push3(ssrRenderComponent($setup.TableRow, { key: record.id, class: "border-b border-border hover:bg-muted/30 transition-colors" }, { default: withCtx((_3, _push4, _parent4, _scopeId3) => {
          if (_push4) _push4(ssrRenderComponent($setup.TableCell, { class: "px-4 py-3" }, { default: withCtx((_4, _push5, _parent5, _scopeId4) => {
            if (_push5) _push5(`<div class="w-16 h-16 rounded-md overflow-hidden bg-muted flex items-center justify-center shrink-0" data-v-5037d8ef${_scopeId4}>`), record.coverUrl ? _push5(`<img${ssrRenderAttr("src", record.coverUrl)}${ssrRenderAttr("alt", record.title)} class="w-full h-full object-cover" data-v-5037d8ef${_scopeId4}>`) : _push5(ssrRenderComponent($setup.SafeIcon, { name: "Image", size: 24, class: "text-muted-foreground" }, null, _parent5, _scopeId4)), _push5("</div>");
            ...
            if (_push5) _push5(`<div class="flex flex-col gap-1" data-v-5037d8ef${_scopeId4}><p class="text-item-title font-medium truncate" data-v-5037d8ef${_scopeId4}>${ssrInterpolate(record.title)}</p><p class="text-caption truncate" data-v-5037d8ef${_scopeId4}>${ssrInterpolate(record.subtitle)}</p></div>`);
            ...
            if (_push5) _push5(`<div class="flex items-center justify-end gap-2" data-v-5037d8ef${_scopeId4}>`), _push5(ssrRenderComponent($setup.Button, { variant: "ghost", size: "sm", class: "h-8 px-3 text-xs", onClick: ($event) => $setup.handleView(record) }, { default: withCtx((_5, _push6, _parent6, _scopeId5) => {
              if (_push6) _push6(ssrRenderComponent($setup.SafeIcon, { name: "Eye", size: 14, class: "mr-1" }, null, _parent6, _scopeId5)), _push6(" 查看 ");
              else return [createVNode($setup.SafeIcon, { name: "Eye", size: 14, class: "mr-1" }), createTextVNode(" 查看 ")];
...
const BrowsingHistoryContent = _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-5037d8ef"]]);
const _sfc_main = defineComponent({ __name: "CommonHeader", props: { isAuthenticated: { type: Boolean, default: false }, userName: { default: "访客用户" }, userAvatar: { default: "" }, currentPath: { default: "./share-home.html" } }, setup(__props, { expose: __expose }) {
  ...
  }, SafeIcon, LoginDialog, FavoritesList, BrowsingHistoryContent, get cn() {
    return cn;
  } };
  return Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true }), __returned__;
} });
