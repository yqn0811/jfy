...
import { p as pcApi, u as uploadTokenStore, D as DialogTitle, a as DialogHeader, b as DialogContent, c as Dialog } from "./DialogTrigger.DclQ-0vq.js";
import { m as mapProduct, I as Input } from "./Input.KonAUKYq.js";
import { S as SafeIcon } from "./SafeIcon.XNuWrfyw.js";
import { B as Button } from "./index.DqCBhDjk.js";
...
import { _ as _export_sfc } from "./BaseLayout.DVPaqkBc.js";
...
const _sfc_main = defineComponent({ __name: "BatchUploadVisitorContent", setup(__props, { expose: __expose }) {
  ...
  const handlePasswordVerified = async () => {
    ...
    if (productId.value) {
      ...
      ownerId.value && params.set("uid", ownerId.value), window.location.href = `./share-home.html?${params.toString()}`;
