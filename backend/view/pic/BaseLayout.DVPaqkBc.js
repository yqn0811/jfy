...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(ssrRenderComponent($setup.Sonner, mergeProps({ class: "toaster group", position: "top-center", "rich-colors": "" }, $setup.props, { "toast-options": { classes: { toast: "group toast jfy-toast group-[.toaster]:shadow-lg", description: "group-[.toast]:text-current/80", actionButton: "group-[.toast]:bg-primary group-[.toast]:text-primary-foreground", cancelButton: "group-[.toast]:bg-muted group-[.toast]:text-muted-foreground" } } }, _attrs), null, _parent));
}
...
}, "/Users/mac/Documents/trae_projects/sub2api/ai_jf/.codex_tmp/jfy-backend-homefix/album-web/src/layouts/BaseLayout.astro", void 0);
export {
  $$BaseLayout as $,
  _export_sfc as _
};
