...
Route::get('/user/home/minicode_image', 'UserApiController/getHomeMiniProgramCodeImage')->middleware('auth', false); // 主页小程序码图片直出（公开，可选登录）
...
Route::post('/user/login/exchange', 'UserApiController/exchangeWechatLoginCode'); // PC网页登录 code 换 token
...
Route::group('common', function (){
    ...
    Route::get('member_upgrade_config', 'CommonApiController/memberUpgradeConfig'); //会员升级入口配置
